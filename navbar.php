<nav class="sticky top-0 z-50 bg-white/80 backdrop-blur-md border-b border-gray-200 py-3">
    <div class="container mx-auto px-4 flex items-center justify-between">
        ...
        <div class="hidden md:flex items-center space-x-6">
            ...
            <a href="index.php?page=categories" class="text-gray-700 hover:text-purple-600 transition-colors">Discover</a>
            <?php if(isset($_SESSION['user_id'])): ?>
                <a href="index.php?page=library" class="text-gray-700 hover:text-purple-600 transition-colors">Library</a>
                <a href="index.php?page=subscriptions" class="text-gray-700 hover:text-purple-600 transition-colors">Subscriptions</a>
            <?php endif; ?>
        </div>
