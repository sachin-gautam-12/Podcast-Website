    ...
    <div class="md:col-span-1">
        ...
        <div class="bg-white rounded-xl shadow-md overflow-hidden mb-6">
            <div class="p-6">
                ...
                <div class="space-y-4">
                    <?php foreach($more_episodes as $more_episode): ?>
                        <?php if($more_episode['id'] != $episode_id && $counter < 5): ?>
                            <?php $counter++; ?>
                            <div class="flex gap-3">
                                <img src="assets/images/podcasts/<?php echo $more_episode['cover_image']; ?>" alt="" class="w-16 h-16 rounded">
                                <div class="flex-1">
                                    <h3 class="font-medium text-gray-900 line-clamp-2"><?php echo $more_episode['title']; ?></h3>
                                    <div class="flex text-xs text-gray-500 mt-1">
                                        <span><?php echo $more_episode['duration']; ?></span>
                                    </div>
                                </div>
                                <a href="index.php?page=listen&id=<?php echo $more_episode['id']; ?>" class="flex-shrink-0 p-2 rounded-full bg-gray-100 hover:bg-gray-200 self-center">
                                    <i class="fas fa-play text-gray-700 text-xs"></i>
                                </a>
                            </div>
                        <?php endif; ?>
                    <?php endforeach; ?>
        ...
        <div class="bg-white rounded-xl shadow-md overflow-hidden">
            <div class="p-6">
                ...
                <div class="space-y-4">
                    <?php foreach($similar_podcasts as $similar): ?>
                        <?php if($similar['id'] != $episode['podcast_id']): ?>
                            <div class="flex gap-3">
                                <img src="assets/images/podcasts/<?php echo $similar['cover_image']; ?>" alt="" class="w-16 h-16 rounded">
                                <div class="flex-1">
                                    <h3 class="font-medium text-gray-900"><?php echo $similar['title']; ?></h3>
                                    <p class="text-xs text-gray-500">By <?php echo $similar['host']; ?></p>
                                </div>
                            </div>
                        <?php endif; ?>
                    <?php endforeach; ?>
